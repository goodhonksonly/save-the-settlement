...
const communicationOptions = [
  ...
  {
    label: "Option B",
    text: "\"I need to inform you that if your account exceeds 60 days past due, your settlement agreement will become null and void. At that point, the full charge-off balance will be due, and the settlement cannot be reinstated. Let&apos;s discuss how to prevent this.\"",
    correct: true,
  },
  {
    label: "Option C",
